...
def build_final_regimens(frame, logs_dir="logs"):
    ...
    # Deduplicate on shortString alone (global uniqueness).
    # Per-condition/regimen mapping is preserved separately in regimens_shortStrings.tsv
    # (the `shortStrings` object in regimens.rda) via generate_shortString_table().
